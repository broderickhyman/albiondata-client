...
const (
	...
	evCustomizationChanged                 EventType = 367
	evBaseVaultInfo                        EventType = 368
	evGuildVaultInfo                       EventType = 369
	evBankVaultInfo                        EventType = 370
	evRecoveryVaultPlayerInfo              EventType = 371
	evRecoveryVaultGuildInfo               EventType = 372
	evUpdateWardrobe                       EventType = 373
	evCastlePhaseChanged                   EventType = 374
	evGuildAccountLogEvent                 EventType = 375
	evNewHideoutObject                     EventType = 376
	evNewHideoutManagement                 EventType = 377
	evNewHideoutExit                       EventType = 378
	evInitHideoutAttackStart               EventType = 379
	evInitHideoutAttackCancel              EventType = 380
	evInitHideoutAttackFinished            EventType = 381
	evHideoutManagementUpdate              EventType = 382
	evIpChanged                            EventType = 383
	evSmartClusterQueueUpdateInfo          EventType = 384
	evSmartClusterQueueActiveInfo          EventType = 385
	evSmartClusterQueueKickWarning         EventType = 386
	evSmartClusterQueueInvite              EventType = 387
	evReceivedGvgSeasonPoints              EventType = 388
	evTerritoryBonusLevelUpdate            EventType = 389
	evOpenWorldAttackScheduleStart         EventType = 390
	evOpenWorldAttackScheduleFinished      EventType = 391
	evOpenWorldAttackScheduleCancel        EventType = 392
	evOpenWorldAttackConquerStart          EventType = 393
	evOpenWorldAttackConquerFinished       EventType = 394
	evOpenWorldAttackConquerCancel         EventType = 395
	evOpenWorldAttackConquerStatus         EventType = 396
	evOpenWorldAttackStart                 EventType = 397
	evOpenWorldAttackEnd                   EventType = 398
	evNewRandomResourceBlocker             EventType = 399
	evNewHomeObject                        EventType = 400
	evHideoutObjectUpdate                  EventType = 401
)
